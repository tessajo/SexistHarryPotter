...
def cleanData(text): # TODO
    ...
    # Armando Dippet
    text = re.sub("[\s,.!?]*Dipper[\s,.!?]*"," Dippet ",text)
    text = re.sub("[\s,.!?]*Dippetto[\s,.!?]*"," Dippet ",text)
    # B
    # Barabas
    ...
    text = re.sub("[\s,.!?]*Hufflepuffs[\s,.!?]*"," Hufflepuff ",text)
    text = re.sub("[\s,.!?]*RAVENCLAW[\s,.!?]*"," Ravenclaw ",text)
    text = re.sub("[\s,.!?]*Ravenclaws[\s,.!?]*"," Ravenclaw ",text)
    ...
    # H
    # Harry Potter
    text = re.sub("[\s,.!?]*HarryPotter[\s,.!?]*"," Harry Potter ",text)
    ...
    text = re.sub("[\s,.!?]*Harry-[\s,.!?]*"," Harry ",text)
    text = re.sub("[\s,.!?]*Harvey[\s,.!?]*"," Harry ",text)
    text = re.sub("[\s,.!?]*Harold[\s,.!?]*"," Harry ",text)
    text = re.sub("[\s,.!?]*Jim[\s,.!?]*"," Harry ",text)
    text = re.sub("[\s,.!?]*Ted[\s,.!?]*"," Harry ",text)
    text = re.sub("[\s,.!?]*Howard[\s,.!?]*"," Harry ",text)
    text = re.sub("[\s,.!?]*Harry tter[\s,.!?]*"," Harry Potter ",text)
    ...
    # Master
    text = re.sub("[\s,.!?]*Masons[\s,.!?]*"," Mason ",text)
    # Malfoy
    ...
    text = re.sub("[\s,.!?]*Malfoys[\s,.!?]*"," Malfoy ",text)
    ...
    # O
    # Ollivander
    text = re.sub("[\s,.!?]*Ollivanders[\s,.!?]*"," Ollivander ",text)
    # Oliver Wood
    ...
    # Parvati Patil
    text = re.sub("[\s,.!?]*Parvati.[\s,.!?]*"," Parvati ",text)
    # Peeves
    ...
    text = re.sub("[\s,.!?]*Weasleys[\s,.!?]*"," Weasley ",text)
    # Wronski
